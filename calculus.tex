...
\tkzfig{fig04}{Fun\c c\~ao de duas senten\c c as}
...
=======
  \subfigure[Função contínua]{
    \input{./figuras/fig02.tikz}\label{funccont}}
  \subfigure[Função descontínua]{
    \input{./figuras/fig03.tikz}\label{funcdesc}}
...
{outro modo}: Multiplicador de Lagrange
